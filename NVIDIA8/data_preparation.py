...
#No-IID division
NUM_CLIENTES = 5  # Change the number based on the experiment

df_ordenado = df.sort_values(by='psa')
indices = np.array_split(df_ordenado.index, NUM_CLIENTES)
datasets_clientes = [df_ordenado.loc[idx] for idx in indices]
