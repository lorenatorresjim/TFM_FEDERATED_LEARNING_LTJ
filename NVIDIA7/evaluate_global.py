...
MODEL_PATH = "poc_workspace/example_project/prod_00/admin@nvidia.com/transfer/44c54b54-ff34-4051-b742-9988351e5523/workspace/app_server/custom/server.npy"
CLIENT_FILES = ["data/client1.csv", "data/client2.csv", "data/client3.csv", "data/client4.csv", "data/client5.csv", "data/client6.csv", "data/client7.csv", "data/client8.csv", "data/client9.csv", "data/client10.csv"]
